                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between gap-4 mb-4">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          <Badge variant={STATUS_COLORS[contact.status as 'new' | 'read' | 'replied' | 'archived']}>
                            {STATUS_LABELS[contact.status as 'new' | 'read' | 'replied' | 'archived']}
                          </Badge>
                          {contact.lead && (
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div>
                  <Badge variant={STATUS_COLORS[selectedContact.status as 'new' | 'read' | 'replied' | 'archived']}>
                    {STATUS_LABELS[selectedContact.status as 'new' | 'read' | 'replied' | 'archived']}
                  </Badge>
                </div>
              </div>
