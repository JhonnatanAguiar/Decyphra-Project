                  ...
                  <tbody>
                    {filteredClients.map((client) => (
                      <tr key={client.id} className="border-b border-dark-700 hover:bg-dark-700/50 transition-colors">
                        ...
                        <td className="p-4">
                          <Badge variant={STATUS_COLORS[client.status as ClientStatus]}>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div>
                  <Badge variant={STATUS_COLORS[selectedClient.status as ClientStatus]}>
                    {STATUS_LABELS[selectedClient.status as ClientStatus]}
                  </Badge>
                </div>
              </div>
            </div>
