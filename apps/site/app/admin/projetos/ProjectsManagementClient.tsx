                  ...
                  <Card key={project.id} variant="interactive" className="overflow-hidden">
                    <div className="relative h-48 bg-dark-700">
                      ...
                      <div className="absolute bottom-2 left-2">
                        <Badge variant={STATUS_COLORS[project.status as 'draft' | 'published' | 'archived']}>
                          {STATUS_LABELS[project.status as 'draft' | 'published' | 'archived']}
                        </Badge>
                      </div>
                    </div>
                    <CardHeader>
          ...
          <div className="space-y-4 flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div>
                  <Badge variant={STATUS_COLORS[selectedProject.status as 'draft' | 'published' | 'archived']}>
                    {STATUS_LABELS[selectedProject.status as 'draft' | 'published' | 'archived']}
                  </Badge>
                </div>
              </div>
              <div>
            ...
            {selectedProject.images && selectedProject.images.length > 0 && (
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  {selectedProject.images.slice(0, 6).map((img: string, idx: number) => (
