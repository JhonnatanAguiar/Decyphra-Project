...
/**
 * Página de Serviço: Consultoria Digital Client Component
 * 
 * Componente client-side da página de Consultoria Digital
 */

export default function ConsultoriaDigitalPageClient() {
  const features = [
